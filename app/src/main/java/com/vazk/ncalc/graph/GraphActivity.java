...
public class GraphActivity extends BaseActivity {
    ...
    private void saveImage() {
        try {
            ...
            if (root.canWrite()) {
                Date d = new Date();
                File imageLoc = new File(root, "com/duy/example/com.vazk.calculator/graph/" + d.getMonth() + d.getDay() + d.getHours() + d.getMinutes() + d.getSeconds() + ".png");
