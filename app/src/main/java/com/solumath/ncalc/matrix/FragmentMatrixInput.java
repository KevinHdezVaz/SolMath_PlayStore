...
package com.solumath.ncalc.matrix;
...
public class FragmentMatrixInput extends Fragment implements View.OnClickListener {
    ...
    public String getMatrixA() {
        ...
        res.append("}");
        Log.d(BasicCalculatorActivity.TAG, "getMatrixA: " + res.toString());
        return res.toString();
    }
    ...
    public String getMatrixB() {
        ...
        Log.d(BasicCalculatorActivity.TAG, "getMatrixB: " + res.toString());
        return res.toString();
    }
    ...
    private void prepareAndCalculate() {
        ...
        Log.w(BasicCalculatorActivity.TAG, s);
