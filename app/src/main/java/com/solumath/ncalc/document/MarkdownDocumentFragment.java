...
import com.solumath.ncalc.document.view.MarkdownDocumentView;
...
public class MarkdownDocumentFragment extends Fragment {
    ...
    public static MarkdownDocumentFragment newInstance(String assetPath) {
        ...
        args.putString(MarkdownListDocumentFragment.KEY_ASSET_PATHS, assetPath);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (arguments != null) {
            String documentPath = arguments.getString(MarkdownListDocumentFragment.KEY_ASSET_PATHS);
