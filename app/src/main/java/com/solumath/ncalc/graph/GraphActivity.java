 ...
 *
 */
package com.solumath.ncalc.graph;
...
public class GraphActivity extends BasseActivity {
    ...
    private void saveImage() {
        try {
            ...
            if (root.canWrite()) {
                Date d = new Date();
                File imageLoc = new File(root, "com/duy/example/com.solumath.calculator/graph/" + d.getMonth() + d.getDay() + d.getHours() + d.getMinutes() + d.getSeconds() + ".png");
