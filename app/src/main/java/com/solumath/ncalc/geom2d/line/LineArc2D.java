...
import com.solumath.ncalc.geom2d.util.AffineTransform2D;
...
import com.solumath.ncalc.geom2d.util.UnboundedShape2DException;
...
public class LineArc2D extends AbstractLine2D implements Cloneable {
    ...
    /* (non-Javadoc)
     * @see com.example.duy.com.duy.calculator.geom2d.circulinear.CirculinearCurve2D#parallel(double)
     */
    ...
    /* (non-Javadoc)
     * @see com.example.duy.com.duy.calculator.geom2d.GeometricObject2D#almostEquals(com.example.duy.com.duy.calculator.geom2d.GeometricObject2D, double)
     */
