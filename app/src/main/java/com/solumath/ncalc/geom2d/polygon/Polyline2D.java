...
public class Polyline2D extends LinearCurve2D
{
     ...
     * (non-Javadoc)
     * 
     * @see com.example.duy.com.duy.calculator.geom2d.OrientedCurve2D#windingAngle(Point2D)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.example.duy.com.duy.calculator.geom2d.OrientedCurve2D#isInside(Point2D)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.example.duy.com.duy.calculator.geom2d.Curve2D#point(double, Point2D)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.example.duy.com.duy.calculator.geom2d.ContinuousCurve2D#appendPath(Path)
     */
